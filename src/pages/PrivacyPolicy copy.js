...
const PrivacyPolicy = () => {
    ...
    return (
      <Container>
        <Box>
          <h1>PRIVACY POLICY FOR FAIRFACE</h1>
        </Box>
        <br />
        <p>
          At FAIRFACE (FAF), one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information
          that is collected and recorded by FAIRFACE and how we use it.
        </p>
        <p>
          If you have additional questions or require more information about our
          Privacy Policy, do not hesitate to contact us at info@fairface.com
        </p>
        <p>
          This Privacy Policy applies only to our online activities and is valid
          for visitors to our website with regards to the information that they
          shared and/or collect in FAIRFACE. This policy is not applicable to any
        ...
        <h2>Log Files</h2>
        <p>
          FAIRFACE follows a standard procedure of using log files. These files log
        ...
        <p>
          Like any other website, FAIRFACE uses ‘cookies’. These cookies are used
              ...
              <span>
                <u>
                  <a
                    ...
                    target="_blank"
                  >
                    &ldquo;What Are Cookies&rdquo; from Cookie Consent
                  </a>
                </u>
              </span>
            </span>
          ...
          <ul>
            <li>
              <a
                style={{ color: "blue" }}
                target="_blank"
                href="Google https://policies.google.com/technologies/ads"
              >
        ...
        <p>
          ...
          advertising partners of FAIRFACE.
        </p>
        <br />
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on FAIRFACE, which are sent directly
        ...
        <br />
        <p>
          Note that FAIRFACE has no access to or control over these cookies that
          are used by third-party advertisers.
        </p>
        <br />
        <h2>Third Party Privacy Policies</h2>
        <p>
          FAIRFACE’s Privacy Policy does not apply to other advertisers or
        ...
        <br />
        <p>
          FIREFACE does not knowingly collect any Personal Identifiable Information
